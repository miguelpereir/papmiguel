    ...
    <div class="container" align="center">
        ...
        <div class="row" align="left">
            <form action="confirmaNovaNoticia.php" method="post" enctype="multipart/form-data">
                ...
                <div class="col-md-5" >
                    <label>Imagem: </label>
                    <img  width="100" id="output_image" src="../images/add%20imagem.png">
                    <input class="custom-file-upload" type="file" accept="image/*" name="imagemNoticia" onchange="preview_image(event)" style="color: darkgray"><br>

                    <label>Foto Capa:</label>
                    <input class="custom-file-upload" type="file" name="capaNoticia"><br>
